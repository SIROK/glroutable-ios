...
// GLRoutable
#define COCOAPODS_POD_AVAILABLE_GLRoutable
#define COCOAPODS_VERSION_MAJOR_GLRoutable 0
#define COCOAPODS_VERSION_MINOR_GLRoutable 1
#define COCOAPODS_VERSION_PATCH_GLRoutable 0
